...
- **Image to text Extractor:** Auto Extract text from an image .
- **Text to audio feature:** Convert response text to audio and play it. 
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/gagan-baghel/ButtlerAI.git
